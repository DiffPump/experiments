#!/bin/bash
# =============================================================================
# Epsilon sensitivity analysis — SLURM job-array worker (DP5, eps sweep)
# =============================================================================
#
# WORKFLOW:
...
#
#   # 2. Submit the array
#   sbatch --array=0-NNNN experiments/benchmarks/r1_5/submit.sh
#
# EDIT ME — account and paths below.
# =============================================================================

#SBATCH --job-name=dfp_r1_5
#SBATCH --account=def-XXXX               # EDIT ME — your allocation
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH --output=experiments/benchmarks/r1_5/slurm_logs/%A_%a.out
#SBATCH --error=experiments/benchmarks/r1_5/slurm_logs/%A_%a.err

# ---------------------------------------------------------------------------
# EDIT ME — paths
# ---------------------------------------------------------------------------
VENV_PATH="${VENV_PATH:-$HOME/envs/diffpump}"
JOBS_CSV="experiments/benchmarks/r1_5/jobs.csv"
...
mkdir -p "experiments/benchmarks/r1_5/slurm_logs"
