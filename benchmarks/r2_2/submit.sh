#!/bin/bash
# =============================================================================
# Table 2 benchmark — SLURM job-array worker
# =============================================================================
#
# WORKFLOW:
...
#
#   # 2. Submit the array
#   sbatch --array=0-NNNN experiments/benchmarks/r2_2/submit.sh
#
#   # 3. After all tasks finish, aggregate
#   python experiments/benchmarks/r2_2/aggregate.py \
#       --results-dir /scratch/$USER/r2_2 \
#       --out experiments/benchmarks/r2_2/r2_2_results.csv
#
# EDIT ME — paths/account below.
# =============================================================================

#SBATCH --job-name=dfp_r2_2
#SBATCH --account=def-XXXX               # EDIT ME — your allocation
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH --output=experiments/benchmarks/r2_2/slurm_logs/%A_%a.out
#SBATCH --error=experiments/benchmarks/r2_2/slurm_logs/%A_%a.err

# ---------------------------------------------------------------------------
# EDIT ME — paths
# ---------------------------------------------------------------------------
VENV_PATH="${VENV_PATH:-$HOME/envs/diffpump}"
JOBS_CSV="experiments/benchmarks/r2_2/jobs.csv"
...
mkdir -p "experiments/benchmarks/r2_2/slurm_logs"
